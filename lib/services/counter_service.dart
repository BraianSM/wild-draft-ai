...
class CounterService {
  ...
  final Map<String, List<String>> _countersMap = {
    ...
    'Maokai_TOP': ['Varus', 'Rumble', 'Olaf', 'Poppy'],
    ...
    'Ryze_TOP': ['Irelia', 'Dr.Mundo', 'Camille', 'Yone'],
    ...
    'Swain_TOP': ['Gwen', 'Heimerdinger', 'Fiora', 'Irelia'],
    ...
    'Yasuo_TOP': ['Renekton', 'Olaf', 'Tryndamere', 'Wukong'],
    'Vayne_TOP': ['Teemo', 'Malphite', 'Pantheon', 'Irelia'],
    'Yone_TOP': ['Irelia', 'Jax', 'Fiora', 'Vayne'],
    'Vladimir_TOP': ['Rumble', 'Ryze', 'Irelia', 'Tryndamere'],
    ...
    'Graves_JG': ['Kindred', 'Lillia', 'Olaf', 'Warwick'],
    ...
    'Katarina_MID': ['Vladimir', 'Diana', 'Fizz', 'Annie'],
    ...
    'Ryze_MID': ["Twisted'Fate", 'Galio', 'Annie', 'Fizz'],
    ...
    'Varus_MID': ['Brand', "Vel'Koz", 'Zoe', 'Mel'],
